<div class="p-4 md:w-1/2">
    <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
        <a href="{{ route('event.show', $event) }}" class="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">
            <img class="lg:h-72 md:h-36 w-full object-cover object-center" src="{{ $event->img_src}}?sig={{ $event->id }}" alt="{{ $event->name }}">
        </a>
        <div class="p-6">
