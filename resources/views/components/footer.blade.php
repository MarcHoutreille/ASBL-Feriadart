    ...
    <div class="container h-72 mx-auto">
        <div class="block md:flex justify-evenly">
            ...
            <div class="text-center md:my-auto">
                <a href="https://www.facebook.com/FeriadArt" class="inline-flex text-black">
                    ...
                    </svg><span class="text-md text-gray-700 underline">{{ __('Check out our Facebook page') }}</span>
                </a>
            </div>
        </div>
    </div>
