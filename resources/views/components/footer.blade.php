<footer class="bg-purple-700 text-yellow-300">
    <div class="container block md:flex items-center md:justify-around py-8 mx-auto">
        <!-- Menu -->
        ...
        <div class="w-full text-center">
            ...
            <a href="https://www.instagram.com/feriadart" class="inline-flex mt-4">
    ...
    <div class="bg-yellow-300 flex items-center justify-center p-4">
        ...
        <!-- ASBL Info -->
        <div class="ml-2">
            <p class="text-purple-700 mx-auto">Feria d'Art ASBL - TVA N° BE 0753.565.581 - Rue Washington 208, 1050 Bruxelles &copy; 2021</p>
        </div>
    </div>
</footer>
