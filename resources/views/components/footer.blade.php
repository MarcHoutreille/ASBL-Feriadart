<footer class="bg-gradient-to-t from-purple-700 via-purple-600 to-purple-500 text-yellow-300 border-t-4 border-yellow-300">
    <div class="w-full block md:flex items-center md:justify-around py-8 mx-auto ">
        <!-- Menu -->
        <div class="w-full md:my-auto mb-4">
            <ul class="text-center text-lg uppercase list-none">
                <li>
                    <a href="{{ route('home') }}" class="text-yellow-200 mx-1 my-auto hover:text-yellow-300 @if (request()->routeIs('home')) text-yellow-300 @endif">{{ __('Home') }}</a>
                </li>
                <li>
                    <a href="{{ route('about') }}" class="text-yellow-200 mx-1 my-auto hover:text-yellow-300 @if (request()->routeIs('about')) text-yellow-300 @endif">{{ __('About Us') }}</a>
                </li>
                <li>
                    <a href="{{ route('events') }}" class="text-yellow-200 mx-1 my-auto hover:text-yellow-300 @if (request()->routeIs('events')) text-yellow-300 @endif">{{ __('Events') }}</a>
                </li>
                <li>
                    <a href="{{ route('gallery') }}" class="text-yellow-200 mx-1 my-auto hover:text-yellow-300 @if (request()->routeIs('gallery')) text-yellow-300 @endif">{{ __('Gallery') }}</a>
                </li>
                <li>
                    <a href="{{ route('articles') }}" class="text-yellow-200 mx-1 my-auto hover:text-yellow-300 @if (request()->routeIs('articles')) text-yellow-300 @endif">{{ __('Articles') }}</a>
                </li>
                <li>
        ...
        <!-- SOCIAL MEDIA LINKS -->
        <div class="w-full flex flex-col align-center justify-center pr-4">
            <a href="https://www.facebook.com/FeriadArt" class="flex justify-center mt-4">
            ...
            <a href="https://www.instagram.com/feriadart" class="flex justify-center mt-4">
                ...
                <span class="text-md ml-2 text-yellow-300 ">{{ __('Follow us on Instagram') }}</span>
            </a>
        </div>
    </div>
