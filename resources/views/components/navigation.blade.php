<nav x-data="{ open: false }" class="bg-gradient-to-b from-purple-700 to-purple-600 border-b-8 border-yellow-300">
    <!-- Primary Navigation Menu -->
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <div class="flex-shrink-0 flex mb-2 items-center">
                ...
                <!-- Navigation Links -->
                <div class="hidden sm:-my-px sm:ml-2 sm:flex">
