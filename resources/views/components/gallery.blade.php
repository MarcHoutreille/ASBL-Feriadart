...
<!--- CAROUSEL --->
<div class="glide h-auto mt-4">
  <h1 class="text-center sm:text-4xl text-3xl font-medium title-font mb-4 text-purple-700 tracking-widest uppercase">{{ $event->name }}</h1>
