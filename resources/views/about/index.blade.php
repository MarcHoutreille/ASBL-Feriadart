<x-guest-layout>
    <section class="container px-4 py-14 mx-auto text-gray-600 body-font">
        <div class="flex flex-col text-center w-full mb-14">
            ...
            <p class="lg:w-full mx-auto leading-relaxed text-justify text-base mt-10">L'asbl Feria d’Art est un marché qui souhaite rendre l’art accessible au plus grand nombre et ce en désacralisant l’achat d’une oeuvre d’art tout en offrant une expérience inclusive pour les artistes et le public. </p>
