                    ...
                    <div class="md:p-12 bg-gray-200 flex flex-row flex-wrap">
                        <div class="md:w-1/2-screen m-0 p-5 bg-white w-full tw-h-full shadow md:rounded-lg">
                            <div class="flex-col flex py-3">
                                ...
                                <input type="text" name="title" class="p-2 shadow rounded-lg bg-gray-100 outline-none focus:bg-gray-200" placeholder="">
                            </div>
                            <div class="flex-col flex py-3">
                                <label class="pb-2 text-gray-700 font-semibold">{{ __('Excerpt') }}</label>
                                <input type="text" name="excerpt" class="p-2 shadow rounded-lg bg-gray-100 outline-none focus:bg-gray-200" placeholder="">
                            </div>
                            <div class="flex-col flex py-3">
                                <label class="pb-2 text-gray-700 font-semibold">{{ __('Body') }}</label>
                                <textarea name="body" class="p-2 shadow rounded-lg bg-gray-100 outline-none focus:bg-gray-200" rows="10"></textarea>
                            </div>
                            <div class="flex-col flex py-3">
                                <label class="pb-2 text-gray-700 font-semibold">{{ __('Author') }}</label>
                                <input type="text" name="author" class="p-2 shadow rounded-lg bg-gray-100 outline-none focus:bg-gray-200" placeholder="">
                            </div>
                            <div class="flex-col flex py-3">
                                <label class="pb-2 text-gray-700 font-semibold">{{ __('Contact Info') }}</label>
                                <input type="text" name="contact" class="p-2 shadow rounded-lg bg-gray-100 outline-none focus:bg-gray-200" placeholder="">
                            </div>
                            <div class="flex-col flex py-3">
