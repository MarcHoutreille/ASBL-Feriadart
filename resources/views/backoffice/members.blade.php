                    ...
                    <div class="md:p-12 bg-gray-200">
                        <div class="bg-white w-full tw-h-full md:w-1/2-screen shadow md:rounded-lg flex flex-wrap p-4">
                            ...
                            <div class="w-full flex-col flex p-3">
                                ...
                                <input type="text" name="img_src" class="p-2 shadow rounded-lg bg-gray-100 outline-none focus:bg-gray-200" @isset($edit) value="{{ $memberToEdit->img_src }}" @endisset required />
                            </div>
                            <div class="w-full md:w-1/2 flex-col flex p-3">
                            ...
                            <div class="w-full md:w-1/2 flex-col flex p-3">
                                ...
                                <input type="tel" name="url" class="p-2 shadow rounded-lg bg-gray-100 outline-none focus:bg-gray-200" @isset($edit) value="{{ $memberToEdit->url }}" @endisset required />
                            </div>
                            <div class="w-full md:w-1/2 flex-col flex p-3">
                                <label class="pb-2 text-gray-700 font-semibold">{{ __('Facebook') }}</label>
                                <input type="text" name="facebook" class="p-2 shadow rounded-lg bg-gray-100 outline-none focus:bg-gray-200" @isset($edit) value="{{ $memberToEdit->facebook }}" @endisset required />
                            </div>
                            <div class="w-full md:w-1/2 flex-col flex p-3">
                                <label class="pb-2 text-gray-700 font-semibold">{{ __('Instagram') }}</label>
                                <input type="text" name="instagram" class="p-2 shadow rounded-lg bg-gray-100 outline-none focus:bg-gray-200" @isset($edit) value="{{ $memberToEdit->instagram }}" @endisset required />
                            </div>
                        </div>
                    </div>
                </div>
