<x-guest-layout>
    <section class="container px-4 py-4 mx-auto text-purple-700 body-font relative">
            ...
            <form action="{{ route('contact.store') }}" method="POST">
                ...
                <div class="flex flex-wrap -m-2">
                    ...
                    <div class="p-2 w-full">
                        ...
                        <button type="submit" class="btn inline-flex text-purple-700 mb-4 bg-yellow-300 hover:bg-yellow-200 border-2 border-purple-700 py-2 px-6 focus:outline-none rounded text-lg">{{ __('Send') }}</button>
                    </div>
                    <div class="p-2 w-full border-t border-gray-200 text-center">
                        ...
                        <span class="inline-flex">
                            ...
                            <a href="https://www.facebook.com/FeriadArt" target="_blank" class="ml-4 text-purple-700">
                                <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
                                    <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                                </svg>
                            </a>
                            <a href="https://www.instagram.com/feriadart" target="_blank" class="ml-4 text-purple-700">
