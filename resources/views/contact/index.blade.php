    ...
    <section class="text-gray-600 body-font relative">
        <div class="container px-4 py-14 mx-auto">
            <div class="flex flex-col text-center w-full mb-14">
                <h1 class="text-2xl font-medium title-font mb-4 text-gray-900 tracking-widest">{{ __('Contact Us') }}</h1>
                ...
                <form action="{{ route('contact.store') }}" method="POST">
                    ...
                    <div class="flex flex-wrap -m-2">
                        ...
                        <div class="p-2 w-full">
                            ...
                            <button type="submit" class="flex ml-auto text-white bg-yellow-300 hover:bg-yellow-200 border-0 py-2 px-8 focus:outline-none rounded text-lg">{{ __('Send') }}</button>
                        </div>
                        <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                            <a class="text-indigo-500">contact@feriadart.art</a>
                            ...
                            <span class="inline-flex">
                                ...
                                <a href="https://www.facebook.com/FeriadArt" target="_blank" class="ml-4 text-gray-500">
                                    <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
                                        <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                                    </svg>
                                </a>
                                <a href="https://www.instagram.com/feriadart" target="_blank" class="ml-4 text-gray-500">
